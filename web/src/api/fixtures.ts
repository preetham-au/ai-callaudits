...
const SUMMARY: Summary = {
  ...
  variables: [
    { name: "premium", required_in: 168, correct: 122, missed: 17, wrong: 29, accuracy: 72.6 },
    { name: "red", required_in: 168, correct: 127, missed: 19, wrong: 22, accuracy: 75.6 },
    { name: "dtd", required_in: 168, correct: 114, missed: 46, wrong: 8, accuracy: 67.9 },
    { name: "reg_no", required_in: 168, correct: 149, missed: 8, wrong: 11, accuracy: 88.7 },
    { name: "ncb", required_in: 121, correct: 85, missed: 33, wrong: 3, accuracy: 70.2 },
    { name: "vehicle_model", required_in: 168, correct: 161, missed: 5, wrong: 2, accuracy: 95.8 },
    { name: "customer_name", required_in: 168, correct: 165, missed: 2, wrong: 1, accuracy: 98.2 },
    { name: "payment_link", required_in: 168, correct: 140, missed: 28, wrong: 0, accuracy: 83.3 },
    { name: "idv", required_in: 44, correct: 17, missed: 23, wrong: 4, accuracy: 38.6 },
    { name: "prev_insurer", required_in: 31, correct: 23, missed: 7, wrong: 1, accuracy: 74.2 },
  ],
};
